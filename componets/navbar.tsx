...
import { faEnvelope, faHome, faTools, faInfoCircle, faShoppingCart, faCog,faUserDoctor, faHospital} from '@fortawesome/free-solid-svg-icons';
// import './globals.css';
import icon from '../app/images/icon.png'
  ...
  return (
    ...
    <Image src={icon} width={50} height={50} alt=''/>
      ...
      {showLinks && (
        <div className='new-links'>
          ...
          <a className="links" href="/Service">
            <FontAwesomeIcon icon={faEnvelope} className="my-icon1"/>Services
          </a>
      ...
      <div className='nav-links'>
        <a className="links" href="../"><FontAwesomeIcon icon={faHome} className="my-icon1"/>Home</a>
        <a className="links" href="/Service"> <FontAwesomeIcon  icon={faCog} className="my-icon1"/>Services</a>
        <a className="links" href="/Staff"> <FontAwesomeIcon icon={faUserDoctor}  className="my-icon1"/> Staff</a>
        <a className="links" href=""> <FontAwesomeIcon icon={faHospital} className="my-icon1"/>Departments</a>

        <a className="links" href=""> <FontAwesomeIcon icon={faInfoCircle} className="my-icon1"/> About Us</a>

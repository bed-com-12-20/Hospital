...
const features = [
  {
    name: "Contact Us",
    description:
      "Contact staff and officials of private hospital through the following numbers 0886262527  0994566128 ",
  },
  {
    name: "Working Hours",
    description:
  ...
  { name: "Departments", description: "Liwonde medical clinical has the following department, X-ray, dental, martenity and many more. each department is managed by team of well trained proffessionals" },
  {
    name: "locations",
              ...
              <div>
               ...
               <div className="items-center justfy-center "> <h2 className="text-3xl font-bold tracking-tight text-green-900 sm:text-4xl">
                ...
                <p className="mt-4 text-gray-500">
                  Welcome to Liwonde medical Clinic, this section provides
